 ...
 * @author wangjing
 */
public class MG0190EditDisplayDialog extends TDialog {

	/** シリアルUID */
	private static final long serialVersionUID = -3465356597300046007L;

	/** コントロールクラス */
	public MG0190EditDisplayDialogCtrl ctrl;
	 ...
	 * @param titleid
	 */
	public MG0190EditDisplayDialog(Frame parent, boolean modal, MG0190EditDisplayDialogCtrl ctrl, String titleid) {
		// 親フレームを設定
		super(parent, modal);
		// コントロールクラスを設定
		this.ctrl = ctrl;
