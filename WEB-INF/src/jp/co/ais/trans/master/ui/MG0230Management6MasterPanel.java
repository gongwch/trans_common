 ...
 * @author wangjing
 */
public class MG0230Management6MasterPanel extends TPanelBusiness {

	/** コントロールクラス */
	private MG0230Management6MasterPanelCtrl ctrl;
	 ...
	 */
	MG0230Management6MasterPanel(MG0230Management6MasterPanelCtrl ctrl) {
		this.ctrl = ctrl;
		// 画面の初期化
		initComponents();
		// スプレッドの初期化
	...
	private void initSpreadSheet() {
		...
		String[] columnLabelMessageIDs = ctrl.columnName;
