 ...
 * @author hayakawa
 */
public class MG0360UserUnLockPanel extends TPanelBusiness {

	/** UID */
	private static final long serialVersionUID = 1285281438447797312L;

	/** コントロール */
	private MG0360UserUnLockPanelCtrl ctrl;
	 ...
	 * @param ctrl 画面コントロール
	 */
	public MG0360UserUnLockPanel(MG0360UserUnLockPanelCtrl ctrl) {
		this.ctrl = ctrl;
	...
	private void initSpreadSheet() {
		String[] slipTypelabel = new String[] { "", "C00589", "C00691", "C03454" };
		int[] columnWidths = new int[] { 3, 10, 20, 10 };
