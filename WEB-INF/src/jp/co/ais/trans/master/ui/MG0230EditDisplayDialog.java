 ...
 * @author wangjing
 */
public class MG0230EditDisplayDialog extends TDialog {

	/** シリアルUID */
	private static final long serialVersionUID = -3465356597300046007L;

	/** コントロールクラス */
	private MG0230EditDisplayDialogCtrl ctrl;
	 ...
	 * @param titleid
	 */
	public MG0230EditDisplayDialog(Frame parent, boolean modal, MG0230EditDisplayDialogCtrl ctrl, String titleid) {
		// 親フレームを設定
		super(parent, modal);
		// コントロールクラスを設定
		this.ctrl = ctrl;
