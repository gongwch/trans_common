 ...
 * @author ookawara
 */
public class MG0230Management6MasterPanelCtrl extends TPanelCtrlBase {

	/** プログラムID */
	private static final String PROGRAM_ID = "MG0230";
	...
	/** パネル */
	protected MG0230Management6MasterPanel panel;
	...
	MG0230EditDisplayDialogCtrl dialog;

	/**
	 * コンストラクタ.
	 */

	public MG0230Management6MasterPanelCtrl() {
		knrName6 = CompanyControlHelper230.getInstance(this.getLoginUserCompanyCode()).getKnrName6();
		columnName = new String[] { "C00596", knrName6 + this.getWord("C00174"), knrName6 + this.getWord("C00518"),
				knrName6 + this.getWord("C00548"), knrName6 + this.getWord("C00160"), "C00055", "C00261" };
		try {
			// 一覧画面の初期化
			panel = new MG0230Management6MasterPanel(this);
		} catch (Exception e) {
			// 正常に処理されませんでした
			errorHandler(panel.getParentFrame(), e, "E00010");
		}

		panel.ctrlBeginManagement.getButton().setText(knrName6);
		panel.ctrlEndManagement.getButton().setText(knrName6);
	...
	void init() {
		...
		ref1.setTitleID(knrName6 + this.getWord("C00500"));
		ref1.setPrefixID(knrName6);
		...
		ref2.setTargetServlet(TARGET_SERVLET);
		ref2.setTitleID(knrName6 + this.getWord("C00500"));
		ref2.setPrefixID(knrName6);
	...
	protected void createEditDisplayDialog(String titleId) {
		dialog = new MG0230EditDisplayDialogCtrl(panel.getParentFrame(), titleId);
	}
	...
	boolean find() {
		...
		try {
			...
			if (Util.isSmallerThen(strBegin, strEnd) == false) {
				...
				showMessage(panel, "W00036", knrName6);
				return false;
			}
