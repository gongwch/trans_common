 ...
 * @author wangjing
 */
public class MG0210Management4MasterPanel extends TPanelBusiness {

	/** コントロールクラス */
	private MG0210Management4MasterPanelCtrl ctrl;
	 ...
	 */
	MG0210Management4MasterPanel(MG0210Management4MasterPanelCtrl ctrl) {
		this.ctrl = ctrl;
		// 画面の初期化
		initComponents();
		// スプレッドの初期化
	...
	protected void initComponents() {
		...
		ctrlBeginManagement.setNoticeSize(255);
		...
		ctrlEndManagement.setNoticeSize(255);
