 ...
 * @author yanwei
 */
public class MG0030EditDisplayDialogCtrl extends PanelAndDialogCtrlBase {

	/** 会社コントロールマスタダイアログ */
	protected MG0030EditDisplayDialog dialog;
	 ...
	 * @param titleid
	 */
	MG0030EditDisplayDialogCtrl(Frame parent, String titleid) {
		// 会社コントロールマスタダイアログの初期化
		dialog = new MG0030EditDisplayDialog(parent, true, this, titleid);
