 ...
 * @author ookawara
 */
public class MG0200Management3MasterPanelCtrl extends TPanelCtrlBase {

	/** プログラムID */
	protected static final String PROGRAM_ID = "MG0200";
	...
	MG0200EditDisplayDialogCtrl dialog;
	...
	protected String getServletName() {
		return "MG0200Management3MasterServlet";
	}
	...
	/** パネル */
	protected MG0200Management3MasterPanel panel;
	 ...
	 * コンストラクタ.
	 */
	public MG0200Management3MasterPanelCtrl() {
		knrName3 = CompanyControlHelper200.getInstance(this.getLoginUserCompanyCode()).getKnrName3();
		columnName = new String[] { "C00596", knrName3 + this.getWord("C00174"), knrName3 + this.getWord("C00518"),
				knrName3 + this.getWord("C00548"), knrName3 + this.getWord("C00160"), "C00055", "C00261" };
		try {
			// 一覧画面の初期化
			panel = new MG0200Management3MasterPanel(this);
		} catch (Exception e) {
			// 正常に処理されませんでした
			errorHandler(panel.getParentFrame(), e, "E00010");
		}
		panel.ctrlBeginManagement.getButton().setText(knrName3);
		panel.ctrlEndManagement.getButton().setText(knrName3);
	...
	void init() {
		...
		ref1.setTitleID(knrName3 + this.getWord("C00500"));
		ref1.setPrefixID(knrName3);
		...
		ref2.setTitleID(knrName3 + this.getWord("C00500"));
		ref2.setPrefixID(knrName3);
	...
	protected void createEditDisplayDialog(String titleId) {
		dialog = new MG0200EditDisplayDialogCtrl(panel.getParentFrame(), titleId);
	}
	...
	boolean find() {
		...
		try {
			...
			if (Util.isSmallerThen(strBegin, strEnd) == false) {
				...
				showMessage(panel, "W00036", knrName3);
				return false;
			}
