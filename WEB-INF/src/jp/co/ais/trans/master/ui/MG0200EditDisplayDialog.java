 ...
 * @author wangjing
 */
public class MG0200EditDisplayDialog extends TDialog {

	/** シリアルUID */
	private static final long serialVersionUID = -3465356597300046007L;

	/** コントロールクラス */
	public MG0200EditDisplayDialogCtrl ctrl;
	 ...
	 * @param titleid
	 */
	public MG0200EditDisplayDialog(Frame parent, boolean modal, MG0200EditDisplayDialogCtrl ctrl, String titleid) {
		// 親フレームを設定
		super(parent, modal);
		// コントロールクラスを設定
		this.ctrl = ctrl;
