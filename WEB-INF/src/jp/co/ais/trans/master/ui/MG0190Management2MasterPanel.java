 ...
 * @author wangjing
 */
public class MG0190Management2MasterPanel extends TPanelBusiness {

	/** コントロールクラス */
	protected MG0190Management2MasterPanelCtrl ctrl;
	 ...
	 */
	MG0190Management2MasterPanel(MG0190Management2MasterPanelCtrl ctrl) {
		this.ctrl = ctrl;
		// 画面の初期化
		initComponents();
		// スプレッドの初期化
