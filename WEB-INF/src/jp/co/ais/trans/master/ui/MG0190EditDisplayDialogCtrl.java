 ...
 * @author ookawara
 */
public class MG0190EditDisplayDialogCtrl extends PanelAndDialogCtrlBase {

	/** 管理マスタダイアログ */
	protected MG0190EditDisplayDialog dialog;
	 ...
	 * @param titleid
	 */
	MG0190EditDisplayDialogCtrl(Frame parent, String titleid) {
		// 管理マスタダイアログの初期化
		dialog = new MG0190EditDisplayDialog(parent, true, this, titleid);

		knrName = CompanyControlHelper190.getInstance(this.getLoginUserCompanyCode()).getKnrName2();
		...
		dialog.addWindowListener(new WindowAdapter() {
			...
			@Override
			public void windowClosing(@SuppressWarnings("unused") WindowEvent ev) {
...
/**
 * CompanyControlHelper190
 */
class CompanyControlHelper190 extends TAppletClientBase {
	...
	/**
	 * @param companyCode
	 * @return CompanyControlHelper190
	 */
	public static CompanyControlHelper190 getInstance(String companyCode) {
		if (!instances.containsKey(companyCode)) {
			CompanyControlHelper190 instance = new CompanyControlHelper190(companyCode);
			instances.put(companyCode, instance);
		}
		return (CompanyControlHelper190) instances.get(companyCode);
	}
	 ...
	 * @param companyCode
	 */
	private CompanyControlHelper190(String companyCode) {
