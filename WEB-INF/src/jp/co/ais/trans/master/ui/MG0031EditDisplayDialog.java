 ...
 */
public class MG0031EditDisplayDialog extends TDialog {

	/** シリアルUID */
	private static final long serialVersionUID = -3465356597300046007L;

	/** コントロールクラス */
	protected MG0031EditDisplayDialogCtrl ctrl;
	 ...
	 */
	public MG0031EditDisplayDialog(Frame parent, boolean modal, MG0031EditDisplayDialogCtrl ctrl, String titleid) {
		// 親フレームを設定
		super(parent, modal);
	...
	protected void initComponents() {
		...
		chkDirectPrintDivision = new TCheckBox();
		...
		pnlDetail2.setMaximumSize(new Dimension(780, 125));
		...
		pnlDetail4.setMaximumSize(new Dimension(370, 125));
		pnlDetail4.setMinimumSize(new Dimension(370, 125));
		pnlDetail4.setPreferredSize(new Dimension(370, 125));
		...
		chkDirectPrintDivision.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
		chkDirectPrintDivision.setLangMessageID(strDirectKbn);
		chkDirectPrintDivision.setMargin(new Insets(0, 0, 0, 0));
		chkDirectPrintDivision.setTabControlNo(27);
		gridBagConstraints = new GridBagConstraints();
		gridBagConstraints.gridx = 0;
		gridBagConstraints.gridy = 3;
		gridBagConstraints.anchor = GridBagConstraints.WEST;
		gridBagConstraints.insets = new Insets(3, 5, 5, 0);
		pnlDetail4.add(chkDirectPrintDivision, gridBagConstraints);
		...
		pnlDetail5.setMaximumSize(new Dimension(450, 125));
		pnlDetail5.setMinimumSize(new Dimension(450, 125));
		pnlDetail5.setPreferredSize(new Dimension(450, 125));
	...
	/** 直接印刷区分 */
	TCheckBox chkDirectPrintDivision;
