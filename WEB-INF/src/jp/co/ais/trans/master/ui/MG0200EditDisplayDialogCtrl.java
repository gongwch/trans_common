 ...
 * @author ookawara
 */
public class MG0200EditDisplayDialogCtrl extends PanelAndDialogCtrlBase {

	/** 管理マスタダイアログ */
	protected MG0200EditDisplayDialog dialog;
	 ...
	 * @param titleid
	 */
	MG0200EditDisplayDialogCtrl(Frame parent, String titleid) {
		// 管理マスタダイアログの初期化
		dialog = createDialog(parent, titleid);

		knrName = CompanyControlHelper200.getInstance(this.getLoginUserCompanyCode()).getKnrName3();
	 ...
	 * @return ダイアログ
	 */
	protected MG0200EditDisplayDialog createDialog(Frame parent, String titleid) {
		return new MG0200EditDisplayDialog(parent, true, this, titleid);
	}
...
class CompanyControlHelper200 extends TAppletClientBase {

	private static Map instances = Collections.synchronizedMap(new HashMap());

	/**
	 * @param companyCode
	 * @return CompanyControlHelper200
	 */
	public static CompanyControlHelper200 getInstance(String companyCode) {
		if (!instances.containsKey(companyCode)) {
			CompanyControlHelper200 instance = new CompanyControlHelper200(companyCode);
			instances.put(companyCode, instance);
		}
		return (CompanyControlHelper200) instances.get(companyCode);
	}
	...
	private CompanyControlHelper200(String companyCode) {
