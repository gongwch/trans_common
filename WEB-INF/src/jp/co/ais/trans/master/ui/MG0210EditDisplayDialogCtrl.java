 ...
 * @author ookawara
 */
public class MG0210EditDisplayDialogCtrl extends PanelAndDialogCtrlBase {

	/** 管理マスタダイアログ */
	protected MG0210EditDisplayDialog dialog;
	 ...
	 * @param titleid
	 */
	MG0210EditDisplayDialogCtrl(Frame parent, String titleid) {
		// 管理マスタダイアログの初期化
		dialog = createDialog(parent, titleid);

		knrName = CompanyControlHelper210.getInstance(this.getLoginUserCompanyCode()).getKnrName4();
	 ...
	 * @return ダイアログ
	 */
	protected MG0210EditDisplayDialog createDialog(Frame parent, String titleid) {
		return new MG0210EditDisplayDialog(parent, true, this, titleid);
	}
...
class CompanyControlHelper210 extends TAppletClientBase {

	private static Map instances = Collections.synchronizedMap(new HashMap());

	/**
	 * @param companyCode
	 * @return CompanyControlHelper210
	 */
	public static CompanyControlHelper210 getInstance(String companyCode) {
		if (!instances.containsKey(companyCode)) {
			CompanyControlHelper210 instance = new CompanyControlHelper210(companyCode);
			instances.put(companyCode, instance);
		}
		return (CompanyControlHelper210) instances.get(companyCode);
	}
	...
	private CompanyControlHelper210(String companyCode) {
