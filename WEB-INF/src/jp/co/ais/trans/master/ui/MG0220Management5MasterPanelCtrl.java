 ...
 * @author ookawara
 */
public class MG0220Management5MasterPanelCtrl extends TPanelCtrlBase {

	/** プログラムID */
	private static final String PROGRAM_ID = "MG0220";
	...
	protected String getServletName() {
		return "MG0220Management5MasterServlet";
	}
	...
	/** パネル */
	protected MG0220Management5MasterPanel panel;
	...
	MG0220EditDisplayDialogCtrl dialog;

	/**
	 * コンストラクタ.
	 */
	public MG0220Management5MasterPanelCtrl() {
		knrName5 = CompanyControlHelper220.getInstance(this.getLoginUserCompanyCode()).getKnrName5();
		columnName = new String[] { "C00596", knrName5 + this.getWord("C00174"), knrName5 + this.getWord("C00518"),
				knrName5 + this.getWord("C00548"), knrName5 + this.getWord("C00160"), "C00055", "C00261" };
		try {
			// 一覧画面の初期化
			panel = new MG0220Management5MasterPanel(this);
		} catch (Exception e) {
			// 正常に処理されませんでした
		...
		panel.ctrlBeginManagement.getButton().setText(knrName5);
		panel.ctrlEndManagement.getButton().setText(knrName5);
	...
	void init() {
		...
		ref1.setTitleID(knrName5 + this.getWord("C00500"));
		ref1.setPrefixID(knrName5);
		...
		ref2.setTitleID(knrName5 + this.getWord("C00500"));
		ref2.setPrefixID(knrName5);
	...
	protected void createEditDisplayDialog(String titleId) {
		dialog = new MG0220EditDisplayDialogCtrl(panel.getParentFrame(), titleId);
	}
	...
	boolean find() {
		...
		try {
			...
			if (Util.isSmallerThen(strBegin, strEnd) == false) {
				...
				showMessage(panel, "W00036", knrName5);
				return false;
			}
			// 表示データの取得
			return reflesh();
