 ...
 * @author wangjing
 */
public class MG0220Management5MasterPanel extends TPanelBusiness {

	/** コントロールクラス */
	private MG0220Management5MasterPanelCtrl ctrl;
	 ...
	 */
	MG0220Management5MasterPanel(MG0220Management5MasterPanelCtrl ctrl) {
		this.ctrl = ctrl;
		// 画面の初期化
		initComponents();
		// スプレッドの初期化
