 ...
 * 会社コントロールマスタ
 */
public class CMP_MST extends MasterBase {
	...
	/** 直接印刷区分（する） */
	public static final int DIRECT_PRINT = 1;
	...
	// * @return 直接印刷区分
	// */
	// public int getDIR_PRINT_KBN() {
	// return dIR_PRINT_KBN;
	// }
	//
	// /**
	// * 直接印刷区分 設定
	// *
	// * @param dir_print_kbn 直接印刷区分
	// */
	// public void setDIR_PRINT_KBN(int dir_print_kbn) {
	// dIR_PRINT_KBN = dir_print_kbn;
	// }
	...
	public String toString() {
		...
		buff.append("/cONV_KBN=").append(cONV_KBN);
		buff.append("]");
