 ...
 * ARŽd–óƒwƒbƒ_
 */
public class AR_SWK_HDR extends MasterBase implements SWK_HDR, Cloneable {

	/**  */
	public static final String TABLE = "AR_SWK_HDR";
	 ...
	 */
	public AR_SWK_HDR clone() {
		try {
			return (AR_SWK_HDR) super.clone();
