 ...
 * @author AIS
 */
public class Management4SearchCondition extends TransferBase implements Cloneable {
	 ...
	 */
	public Management4SearchCondition clone() {
		try {
			return (Management4SearchCondition) super.clone();
	 ...
	 * @return コード(複数)
	 */
	public String[] getManagement4CodeList() {
		if (codeList.isEmpty()) {
			return null;
		}
	 ...
	 * コード(複数)の設定
	 * 
	 * @param Management4CodeList コード(複数)
	 */
	public void setManagement4CodeList(String[] Management4CodeList) {
		addManagement4Code(Management4CodeList);
	}
	 ...
	 * @param list コード(複数)
	 */
	public void addManagement4Code(String... list) {
		for (String Management4Code : list) {
			this.codeList.add(Management4Code);
		}
	}
	 ...
	 * コード(複数)のクリア
	 */
	public void clearManagement4CodeList() {
		codeList.clear();
	}
