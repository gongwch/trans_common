 ...
 * @author AIS
 */
public class Management5SearchCondition extends TransferBase implements Cloneable {
	 ...
	 */
	public Management5SearchCondition clone() {
		try {
			return (Management5SearchCondition) super.clone();
	 ...
	 * @return コード(複数)
	 */
	public String[] getManagement5CodeList() {
		if (codeList.isEmpty()) {
			return null;
		}
	 ...
	 * コード(複数)の設定
	 * 
	 * @param Management5CodeList コード(複数)
	 */
	public void setManagement5CodeList(String[] Management5CodeList) {
		addManagement5Code(Management5CodeList);
	}
	 ...
	 * @param list コード(複数)
	 */
	public void addManagement5Code(String... list) {
		for (String Management5Code : list) {
			this.codeList.add(Management5Code);
		}
	}
	 ...
	 * コード(複数)のクリア
	 */
	public void clearManagement5CodeList() {
		codeList.clear();
	}
