 ...
 * 承認権限ロールグループマスタ検索条件
 */
public class AprvRoleGroupSearchCondition extends TransferBase implements Cloneable {
	 ...
	 */
	@Override
	public AprvRoleGroupSearchCondition clone() {
		try {
			return (AprvRoleGroupSearchCondition) super.clone();
