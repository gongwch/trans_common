 ...
 * @author AIS
 */
public class MG0210Management4MasterDialog extends TDialog {
	 ...
	 * @param mordal
	 */
	public MG0210Management4MasterDialog(Company company, Frame parent, boolean mordal) {
	...
	public void allocateComponents() {
		...
		if (company.getAccountConfig().getManagement4Name() == null) {
			mngt = getShortWord("C01031");
		} else {
			mngt = company.getAccountConfig().getManagement4Name();
		}
