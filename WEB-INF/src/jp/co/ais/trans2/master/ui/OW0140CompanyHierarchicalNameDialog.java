 ...
 * 会社階層名称設定マスタの編集画面
 */
public class OW0140CompanyHierarchicalNameDialog extends TDialog {
	 ...
	 * @param mordal
	 */
	public OW0140CompanyHierarchicalNameDialog(Company company, Frame parent, boolean mordal) {
