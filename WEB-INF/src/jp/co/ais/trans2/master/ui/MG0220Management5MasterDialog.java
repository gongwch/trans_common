 ...
 * @author AIS
 */
public class MG0220Management5MasterDialog extends TDialog {
	 ...
	 * @param mordal
	 */
	public MG0220Management5MasterDialog(Company company, Frame parent, boolean mordal) {
	...
	public void allocateComponents() {
		...
		if (Util.isNullOrEmpty(company.getAccountConfig().getManagement5Name())) {
			mngt = getShortWord("C01033");
		} else {
			mngt = company.getAccountConfig().getManagement5Name();
		}
