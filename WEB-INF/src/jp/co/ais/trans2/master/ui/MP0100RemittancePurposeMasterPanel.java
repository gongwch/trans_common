 ...
 * 新送金目的マスタの指示画面
 */
public class MP0100RemittancePurposeMasterPanel extends TMainPanel {
	...
	/** 範囲検索コンポーネント */
	public TRemittanceReferenceRange ctrlSearch;
	 ...
	 * @param company
	 */
	public MP0100RemittancePurposeMasterPanel(Company company) {
		super(company);
	}
	...
	public void initComponents() {
		...
		ctrlSearch = new TRemittanceReferenceRange();
		tbl = new TTable();
		tbl.addColumn(SC.purposeCode, "C00793", 150); // 送金目的コード
		tbl.addColumn(SC.balanceCode, "C11839", 150); // 国際収支コード
		tbl.addColumn(SC.purposeName, "C11840", 250); // 送金目的名称
