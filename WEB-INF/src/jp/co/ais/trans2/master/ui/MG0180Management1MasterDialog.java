 ...
 * @author AIS
 */
public class MG0180Management1MasterDialog extends TDialog {
	 ...
	 * @param mordal
	 */
	public MG0180Management1MasterDialog(Company company, Frame parent, boolean mordal) {
	...
	public void allocateComponents() {
		...
		if (company.getAccountConfig().getManagement1Name() == null) {
			...
			mngt = company.getAccountConfig().getManagement1Name();
		}
