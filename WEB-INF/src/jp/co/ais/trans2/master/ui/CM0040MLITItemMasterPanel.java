 ...
 * @author AIS
 */
public class CM0040MLITItemMasterPanel extends TMainPanel {
	...
	/** 範囲 */
	public TMlitItemReferenceRange ctrlRange;
	 ...
	 * コンストラクタ.
	 */
	public CM0040MLITItemMasterPanel() {
		super();
	}
	...
	public void initComponents() {
		...
		ctrlRange = new TMlitItemReferenceRange();

		pnlSearchCondition = new TPanel();

		tbl = new TTable();
		tbl.addColumn(SC.code, getWord("CBL303"), 80); // アイテムコード
		tbl.addColumn(SC.name, getWord("CBL304"), 180); // アイテム名称
