 ...
 * @author AIS
 */
public class MG0210Management4MasterPanel extends TMainPanel {
	...
	/** 管理4範囲検索 */
	public TManagement4ReferenceRange management4Range;
	...
	/**
	 * コンストラクタ。会社情報は管理4名称の取得等に使用するため必須。
	 * 
	 * @param company 会社
	 */
	public MG0210Management4MasterPanel(Company company) {
		super(company);
	}
	...
	public void initComponents() {
		...
		management4Range = new TManagement4ReferenceRange();
		chkOutputTermEnd = new TCheckBox();

		tbl = new TTable();
		String caption = company.getAccountConfig().getManagement4Name();
	...
	public void allocateComponents() {
		...
		// 管理4検索範囲
		management4Range.setLocation(20, 20);
		pnlSearchCondition.add(management4Range);
	...
	public void setTabIndex() {
		int i = 0;
		management4Range.setTabControlNo(i++);
