 ...
 * 部門階層マスタの編集画面
 */
public class MG0051DepartmentHierarchySelectionDepDialog extends TDialog {
	 ...
	 * @param mordal
	 */
	public MG0051DepartmentHierarchySelectionDepDialog(Company company, Frame parent, boolean mordal) {
