 ...
 * @author AIS
 */
public class MG0230Management6MasterPanel extends TMainPanel {
	...
	/** 管理６範囲検索 */
	public TManagement6ReferenceRange management6Range;
	...
	/**
	 * コンストラクタ。会社情報は管理6名称の取得等に使用するため必須。
	 * 
	 * @param company 会社
	 */
	public MG0230Management6MasterPanel(Company company) {
		super(company);
	}
	...
	public void initComponents() {
		...
		management6Range = new TManagement6ReferenceRange();
		chkOutputTermEnd = new TCheckBox();

		tbl = new TTable();
		String caption = company.getAccountConfig().getManagement6Name();
		// 会社コード
	...
	public void allocateComponents() {
		...
		// 管理6検索範囲
		management6Range.setLocation(20, 20);
		pnlSearchCondition.add(management6Range);
	...
	public void setTabIndex() {
		int i = 0;
		management6Range.setTabControlNo(i++);
