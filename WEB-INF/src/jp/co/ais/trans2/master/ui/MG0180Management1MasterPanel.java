 ...
 * @author AIS
 */
public class MG0180Management1MasterPanel extends TMainPanel {
	...
	/** 管理1範囲検索 */
	public TManagement1ReferenceRange management1Range;
	 ...
	 */
	public enum SC {
		code, name, names, namek, dateFrom, dateTo
	}

	/**
	 * コンストラクタ。会社情報は管理1名称の取得等に使用するため必須。
	 * 
	 * @param company 会社
	 */
	public MG0180Management1MasterPanel(Company company) {
		super(company);
	}
	...
	public void initComponents() {
		...
		management1Range = new TManagement1ReferenceRange();
		chkOutputTermEnd = new TCheckBox();

		tbl = new TTable();
		String caption = company.getAccountConfig().getManagement1Name();
		// コード
	...
	public void allocateComponents() {
		...
		// 管理1検索範囲
		management1Range.setLocation(20, 20);
		pnlSearchCondition.add(management1Range);
	...
	public void setTabIndex() {
		int i = 0;
		management1Range.setTabControlNo(i++);
