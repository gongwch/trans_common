 ...
 * @author AIS
 */
public class MG0200Management3MasterPanel extends TMainPanel {
	...
	/** 管理3範囲検索 */
	public TManagement3ReferenceRange management3Range;
	...
	/**
	 * コンストラクタ。会社情報は管理3名称の取得等に使用するため必須。
	 * 
	 * @param company 会社
	 */
	public MG0200Management3MasterPanel(Company company) {
		super(company);
	}
	...
	public void initComponents() {
		...
		management3Range = new TManagement3ReferenceRange();
		chkOutputTermEnd = new TCheckBox();

		tbl = new TTable();

		String caption = company.getAccountConfig().getManagement3Name();

		// 会社コード
		tbl.addColumn(SC.code, "C00596", -1);
		// コード
	...
	public void allocateComponents() {
		...
		// 管理3検索範囲
		management3Range.setLocation(20, 20);
		pnlSearchCondition.add(management3Range);
	...
	public void setTabIndex() {
		int i = 0;
		management3Range.setTabControlNo(i++);
