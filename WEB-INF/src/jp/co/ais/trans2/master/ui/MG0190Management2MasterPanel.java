 ...
 * @author AIS
 */
public class MG0190Management2MasterPanel extends TMainPanel {

	/** serialVersionUID */
	private static final long serialVersionUID = 5920647904653726978L;
	...
	/** 管理2範囲検索 */
	public TManagement2ReferenceRange management2Range;
	 ...
	 */
	public enum SC {
		comCode,code, name, names, namek, dateFrom, dateTo
	}

	/**
	 * コンストラクタ。会社情報は管理２名称の取得等に使用するため必須。
	 * 
	 * @param company 会社
	 */
	public MG0190Management2MasterPanel(Company company) {
		super(company);
	}
	...
	public void initComponents() {
		...
		management2Range = new TManagement2ReferenceRange();
		chkOutputTermEnd = new TCheckBox();

		tbl = new TTable();
		String caption = company.getAccountConfig().getManagement2Name();
		// 会社コード
		tbl.addColumn(SC.comCode, getWord("C00596"), -1);
		// コード
	...
	public void allocateComponents() {
		...
		// 管理２検索範囲
		management2Range.setLocation(20, 20);
		pnlSearchCondition.add(management2Range);

		// 有効期間切れ表示
		chkOutputTermEnd.setLangMessageID("C11089");
		chkOutputTermEnd.setSize(200, 20);
	...
	public void setTabIndex() {
		int i = 0;
		management2Range.setTabControlNo(i++);
