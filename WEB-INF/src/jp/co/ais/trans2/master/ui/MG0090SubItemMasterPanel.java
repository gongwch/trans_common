 ...
 * 補助科目マスタの指示画面
 */
public class MG0090SubItemMasterPanel extends TMainPanel {
	...
	/** 範囲検索コンポーネント */
	public TSubItemRange ctrlSerch;
	 ...
	 * @param company
	 */
	public MG0090SubItemMasterPanel(Company company) {
		super(company);
	}
	...
	public void initComponents() {
		...
		ctrlSerch = new TSubItemRange();
		tbl = new TTable();
		tbl.addColumn(SC.kmkcode, "C00572", 100, SwingConstants.LEFT);
		tbl.addColumn(SC.kmkname, "C00700", 200, SwingConstants.LEFT);
		tbl.addColumn(SC.code, "C00890", 100, SwingConstants.LEFT);
		tbl.addColumn(SC.name, "C00934", 200, SwingConstants.LEFT);
		tbl.addColumn(SC.names, "C00933", 150, SwingConstants.LEFT);
		tbl.addColumn(SC.namek, "C00935", 200, SwingConstants.LEFT);
		tbl.addColumn(SC.ukmkbn, "C01264", 150, SwingConstants.CENTER);
		if (isUseKoteiDep) {
			tbl.addColumn(SC.koteidepcode, "C02066", 100, SwingConstants.LEFT);
		} else {
			tbl.addColumn(SC.koteidepcode, "C02066", -1, SwingConstants.LEFT);
		}
		...
		if (company.getAccountConfig().getManagement5Name() != null) {
			...
			tbl.addColumn(SC.knrflg5, "C01034", 100);
		}
