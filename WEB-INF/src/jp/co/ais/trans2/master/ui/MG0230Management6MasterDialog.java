 ...
 * @author AIS
 */
public class MG0230Management6MasterDialog extends TDialog {
	 ...
	 * @param mordal
	 */
	public MG0230Management6MasterDialog(Company company, Frame parent, boolean mordal) {
	...
	public void allocateComponents() {
		...
		if (Util.isNullOrEmpty(company.getAccountConfig().getManagement6Name())) {
			mngt = getShortWord("C01035");
		} else {
			mngt = company.getAccountConfig().getManagement6Name();
		}
