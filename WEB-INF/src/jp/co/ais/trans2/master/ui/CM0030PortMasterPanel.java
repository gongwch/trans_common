 ...
 * @author AIS
 */
public class CM0030PortMasterPanel extends TMainPanel {
	...
	/** 港範囲検索 */
	public TPortReferenceRange ctrlPortRange;
	...
	public void initComponents() {
		...
		ctrlPortRange = new TPortReferenceRange();
		chkOutputTermEnd = new TCheckBox();

		tbl = new TTable();
		tbl.addColumn(SC.code, getWord("C00584"), 100); // 港コード
		tbl.addColumn(SC.name, getWord("C00585"), 200); // 港名称
		tbl.addColumn(SC.names, getWord("C00586"), 200); // 港略称
		tbl.addColumn(SC.namek, getWord("C00587"), 200); // 港検索名称
	...
	public void allocateComponents() {
		...
		// 港コード検索範囲
		ctrlPortRange.setLocation(20, 20);
		pnlSearchCondition.add(ctrlPortRange);
	...
	public void setTabIndex() {
		int i = 1;
		ctrlPortRange.setTabControlNo(i++);
