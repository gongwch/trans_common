 ...
 * @author AIS
 */
public class MG0200Management3MasterDialog extends TDialog {
	 ...
	 * @param mordal
	 */
	public MG0200Management3MasterDialog(Company company, Frame parent, boolean mordal) {
	...
	public void allocateComponents() {
		...
		if (company.getAccountConfig().getManagement3Name() == null) {
			mngt = getShortWord("C01029");
		} else {
			mngt = company.getAccountConfig().getManagement3Name();
		}
