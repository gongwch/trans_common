...
/**
 * 補助科目マスタチェックボックスのコンポーネント
 */
public class ItemCheckBox extends TPanel {
	 ...
	 * @param company
	 */
	public ItemCheckBox(Company company) {
	...
	public void allocateComponents() {
		...
		chkempcodeflg.setSize(170, 20);
		chkempcodeflg.setLocation(360, 0);
		add(chkempcodeflg);
		...
		if (company.getAccountConfig().getManagement1Name() != null) {
			chkknrflg1.setLangMessageID(company.getAccountConfig().getManagement1Name()
				+ TModelUIUtil.getWord("C00423"));
		} else {
			chkknrflg1.setLangMessageID("C01026");
		}
		chkknrflg1.setSize(170, 20);
		chkknrflg1.setLocation(360, 20);
		add(chkknrflg1);
		...
		chkknrflg2.setSize(170, 20);
		chkknrflg2.setLocation(360, 40);
		add(chkknrflg2);
		...
		chkknrflg3.setSize(170, 20);
		chkknrflg3.setLocation(360, 60);
		add(chkknrflg3);
		...
		chkknrflg4.setSize(170, 20);
		chkknrflg4.setLocation(360, 80);
		add(chkknrflg4);
		...
		chkknrflg5.setSize(170, 20);
		chkknrflg5.setLocation(360, 100);
		add(chkknrflg5);
		...
		chkknrflg6.setSize(170, 20);
		chkknrflg6.setLocation(360, 120);
		add(chkknrflg6);
		...
		chkhmflg1.setSize(170, 20);
		chkhmflg1.setLocation(540, 0);
		add(chkhmflg1);
		...
		chkhmflg2.setSize(170, 20);
		chkhmflg2.setLocation(540, 20);
		add(chkhmflg2);
		...
		chkhmflg3.setSize(170, 20);
		chkhmflg3.setLocation(540, 40);
		add(chkhmflg3);

		// 売上課税入力フラグ
		chkurizeiflg.setLangMessageID("C01282");
		chkurizeiflg.setSize(170, 20);
		chkurizeiflg.setLocation(540, 60);
		add(chkurizeiflg);

		// 仕入課税入力フラグ
		chksirzeiflg.setLangMessageID("C01088");
		chksirzeiflg.setSize(170, 20);
		chksirzeiflg.setLocation(540, 80);
		add(chksirzeiflg);

		// 多通貨入力フラグ
		chkmcrflg.setLangMessageID("C01223");
		chkmcrflg.setSize(170, 20);
		chkmcrflg.setLocation(540, 100);
		add(chkmcrflg);

		// 評価替対象フラグ
		chkexcflg.setLangMessageID("C01301");
		chkexcflg.setSize(170, 20);
		chkexcflg.setLocation(540, 120);
		add(chkexcflg);
	...
	public void setTabControlNo(int tabControlNo) {
		...
		chkOccurDate.setTabControlNo(tabControlNo);
		...
		chkexcflg.setTabControlNo(tabControlNo);
