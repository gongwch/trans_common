 ...
 * @author AIS
 */
public class TManagement6ReferenceController extends TReferenceController {
	 ...
	 * @param field フィールド
	 */
	public TManagement6ReferenceController(TReference field) {
		super(field);
	}
	...
	public void btnSearch_Click() {
		...
		try {
			...
			// データを抽出する
			Management6SearchCondition condition_ = getCondition().clone();
			// コード前方一致
			...
			List<Management6> list = getList(condition_);
	 ...
	 * @return 管理6情報
	 */
	protected Management6 getInputtedEntity() {
		...
		try {
			...
			Management6SearchCondition condition_ = condition.clone();
	 ...
	 */
	protected Management6SearchCondition getCondition() {
		return condition;
	}
	 ...
	 * @return 管理6情報
	 */
	protected Management6 getSelectedEntity() {
		return (Management6) dialog.tbl.getSelectedRowValueAt(TReferenceDialog.SC.bean);
	}

	@Override
	public String getDialogCaption() {
		return getCompany().getAccountConfig().getManagement6Name();
	}
	...
	public Management6 getEntity() {
		return (Management6) super.getEntity();
	}
	 ...
	 * @return フィールド
	 */
	public TManagement6Reference getField() {
		return (TManagement6Reference) field;
	}
	...
	public void refleshEntity() {
		Management6 bean = getInputtedEntity();
		setEntity(bean);
	}
	...
	public Object getUnspecifiedEntity() {
		Management6 entity1 = new Management6();
