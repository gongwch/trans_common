 ...
 * @author AIS
 */
public class TManagement3ReferenceController extends TReferenceController {
	 ...
	 * @param field フィールド
	 */
	public TManagement3ReferenceController(TReference field) {
		super(field);
	}
	...
	public void btnSearch_Click() {
		...
		try {
			...
			// データを抽出する
			Management3SearchCondition condition_ = getCondition().clone();
			// コード前方一致
			...
			List<Management3> list = getList(condition_);
	 ...
	 * @return 管理3情報
	 */
	protected Management3 getInputtedEntity() {
		...
		try {
			...
			Management3SearchCondition condition_ = condition.clone();
	 ...
	 */
	protected Management3SearchCondition getCondition() {
		return condition;
	}
	 ...
	 * @return 管理3情報
	 */
	protected Management3 getSelectedEntity() {
		return (Management3) dialog.tbl.getSelectedRowValueAt(TReferenceDialog.SC.bean);
	}

	@Override
	public String getDialogCaption() {
		return getCompany().getAccountConfig().getManagement3Name();
	...
	public Management3 getEntity() {
		return (Management3) super.getEntity();
	}
	 ...
	 * @return フィールド
	 */
	public TManagement3Reference getField() {
		return (TManagement3Reference) field;
	}
	...
	public void refleshEntity() {
		Management3 bean = getInputtedEntity();
		setEntity(bean);
	}
	...
	public Object getUnspecifiedEntity() {
		Management3 entity1 = new Management3();
