 ...
 * @author AIS
 */
public class TAprvRoleGroupListSelector extends TPanel {
	...
	/** コントローラ */
	protected TAprvRoleGroupListSelectorController controller;
	 ...
	 *
	 */
	public TAprvRoleGroupListSelector() {
		this(true);
	}
	 ...
	 */
	public TAprvRoleGroupListSelector(boolean isRefresh) {
		...
		// コントローラ生成
		controller = new TAprvRoleGroupListSelectorController(this, isRefresh);
	...
	public void initComponents() {
		...
		tbl.addColumn(SC.NAME, "C12229", 100); // 承認グループ
	 ...
	 * チェックした承認グループコードを返す
	 * 
	 * @return List<承認グループコード>
	 */
	public List<String> getCheckedAprvGroupCode() {
