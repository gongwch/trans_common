...
/**
 * 自動仕訳科目検索ダイアログの基底 検索名称を削除
 * 
 * @author AIS
 */
public class TAutomaticJournalizingItemReferenceDialog extends TReferenceDialog {
	
	/**
	 * @param controller
	 */
	public TAutomaticJournalizingItemReferenceDialog(TReferenceController controller) {
		super(controller);		
	}
	...
	protected void initComponents() {
		...
		tbl.addColumn(SC.code, getWord("C01008"), 100); // XXコード
		tbl.addColumn(SC.names, getWord("C11885"), 200); // 略称
		code = new TTextField();
