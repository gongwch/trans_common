 ...
 * @param <T> Enum
 */
public class TEnumCheckBoxTitlePanel<T extends TEnumRadio> extends TTitlePanel {
	 ...
	 * コンストラクタ(横)
	 */
	public TEnumCheckBoxTitlePanel() {
	 ...
	 */
	public TEnumCheckBoxTitlePanel(int alignment) {
		this(alignment, 0);
	}
	 ...
	 */
	public TEnumCheckBoxTitlePanel(int alignment, int leftMargin) {
	 ...
	 */
	public TEnumCheckBoxTitlePanel(int alignment, int leftMargin, int height) {
	 ...
	 * @param title タイトル
	 */
	public TEnumCheckBoxTitlePanel(String title) {
		this();
