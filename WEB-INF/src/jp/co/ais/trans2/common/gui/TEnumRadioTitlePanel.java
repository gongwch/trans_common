 ...
 * @param <T> Enum
 */
public class TEnumRadioTitlePanel<T extends TEnumRadio> extends TTitlePanel {
	 ...
	 */
	public TEnumRadioTitlePanel(int alignment) {
		this(alignment, 0);
	}
	 ...
	 */
	public TEnumRadioTitlePanel(int alignment, int leftMargin) {
	 ...
	 */
	public TEnumRadioTitlePanel(int alignment, int leftMargin, int height) {
	 ...
	 * @param title タイトル
	 */
	public TEnumRadioTitlePanel(String title) {
		this();
