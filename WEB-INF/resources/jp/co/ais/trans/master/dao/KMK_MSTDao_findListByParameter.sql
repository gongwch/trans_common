...
/*IF param.itemSystemCode != null && (!"".equals(param.itemSystemCode))*/
	...
	/*END*/     	
/*END*/ 
/*IF param.itemCode != ""*/ AND kmk.KMK_CODE  /*$param.itemCode*/  /*END*/ -- LIKE
/*IF param.itemAbbrName != "" */ AND kmk.KMK_NAME_S  /*$param.itemAbbrName*/  /*END*/ -- LIKE
/*IF param.itemNameForSearch != "" */ AND kmk.KMK_NAME_K  /*$param.itemNameForSearch*/  /*END*/ -- LIKE
...
/*IF param.beginCode != null && !"".equals(param.beginCode)*/ AND kmk.KMK_CODE >= /*param.beginCode*/ /*END*/
/*IF param.endCode != null && !"".equals(param.endCode)*/ AND kmk.KMK_CODE <= /*param.endCode*/ /*END*/
