...
/*IF param.subItemCode != "" */AND HKM_CODE  /*$param.subItemCode*/  /*END*/ -- LIKE
/*IF param.subItemAbbrName != "" */AND HKM_NAME_S  /*$param.subItemAbbrName*/  /*END*/ -- LIKE
/*IF param.subItemNameForSearch != "" */AND HKM_NAME_K  /*$param.subItemNameForSearch*/  /*END*/ -- LIKE
...
/*IF param.beginCode != null && !"".equals(param.beginCode)*/ AND HKM_CODE >= /*param.beginCode*/ /*END*/
/*IF param.endCode != null && !"".equals(param.endCode)*/ AND HKM_CODE <= /*param.endCode*/ /*END*/
