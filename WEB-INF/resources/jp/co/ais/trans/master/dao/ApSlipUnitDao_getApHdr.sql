SELECT 
  ...
  cbk.CBK_BNK_CODE                HDR_CBK_BNK_CODE,
  cbk.CBK_STN_CODE                HDR_CBK_STN_CODE,
  bnk.BNK_NAME_S                  HDR_CBK_BANK_NAME,
  bnk.BNK_STN_NAME_S              HDR_CBK_BANK_STN_NAME,
  densyu.DEN_SYU_NAME_K           DEN_SYU_NAME_K,
  shihabmn.DEP_NAME               HDR_DEP_NAME,
  shihabmn.DEP_NAME_S             HDR_DEP_NAME_S,
  ...
  FROM (SELECT * 
         ...
         /*IF !"".equals(param.utkNo) && param.utkNo != null */               AND SWK_UTK_NO         = /*param.utkNo*/           /*END*/         
         /*IF !"".equals(param.kariDrDenNo) && param.kariDrDenNo != null */   AND SWK_KARI_DR_DEN_NO = /*param.kariDrDenNo*/     /*END*/
         ...
         /*IF !"".equals(param.depCode) && param.depCode != null */           AND SWK_DEP_CODE       = /*param.depCode*/         /*END*/
         /*IF !"".equals(param.tukeKbn) && param.tukeKbn != null */           AND SWK_TUKE_KBN       = /*param.tukeKbn*/         /*END*/
         ...
         /*IF param.underDenDate != null */                                   AND SWK_DEN_DATE       <= /*param.underDenDate*/   /*END*/
         /*IF param.underSsyDate != null */                                   AND SWK_SSY_DATE       <= /*param.underSsyDate*/   /*END*/
         /*IF param.notSihaKin != null */                                     AND SWK_SIHA_KIN       <> /*param.notSihaKin*/     /*END*/
         /*IF !"".equals(param.shrKbn) && param.shrKbn != null */
           /*IF !"".equals(param.notHaitaKariCrDenNo) && param.notHaitaKariCrDenNo != null */
               AND ( (SWK_SHR_KBN = 0 ) OR (SWK_KARI_CR_DEN_NO = /*param.notHaitaKariCrDenNo*/ ) )
           --  ELSE  
  ...
  LEFT OUTER JOIN BMN_MST shihabmn   ON hdr.KAI_CODE     = shihabmn.KAI_CODE
                                    AND hdr.SWK_DEP_CODE = shihabmn.DEP_CODE
  WHERE '1' = '1'
  ...
  /*IF !"".equals(param.swkInKbn) && param.swkInKbn != null */               AND densyu.SWK_IN_KBN = /*param.swkInKbn*/           /*END*/
  /*IF param.denSyuCode != null */
    AND (densyu.DEN_SYU_CODE IN /*param.denSyuCode*/() OR densyu.TA_SYS_KBN = 1)
  /*END*/
