SELECT 
  ...
  dtlBmn.DEP_NAME_S               SWK_DEP_NAME_S
  FROM (SELECT * 
          FROM AP_SWK_HDR
         WHERE '1' = '1' 
         /*IF !"".equals(param.kaiCode) && param.kaiCode != null */           AND KAI_CODE       =  /*param.kaiCode*/       /*END*/
  ...
  INNER JOIN      SWK_DTL    dtl     ON hdr.KAI_CODE     = dtl.KAI_CODE
  ...
  LEFT OUTER JOIN BMN_MST dtlBmn     ON dtl.KAI_CODE     = dtlBmn.KAI_CODE
                                    AND dtl.SWK_DEP_CODE = dtlBmn.DEP_CODE
  WHERE '1' = '1'
