SELECT
  ...
  swk.HAS_DATE,
  swk.DEN_SYU_CODE,
  swk.SWK_SOUSAI_GYO_NO, --  ‘ŠŽE“`•[s”Ô†
  swk.SWK_EST_DEN_NO,    --  `”ïŠTŽZ“`•[”Ô†
  swk.SWK_STL_DEN_NO,    --  `”ïŽÀŽZ“`•[”Ô†
  swk.SWK_MAE_DEN_NO,    --  `”ï‘O“n‹à“`•[”Ô†
  swk.SWK_MAE_GYO_NO,    --  `”ï‘O“n‹às”Ô†
  DEN_SYU_CODE,
  ...
  funcCur.CUR_CODE  FUNC_CUR_CODE,        --  ‹@”\’Ê‰Ý
  funcCur.DEC_KETA  FUNC_CUR_DEC_KETA,    --  ‹@”\’Ê‰Ý¬”“_Œ…”
...
FROM SWK_DTL swk
  ...
  LEFT OUTER JOIN CUR_MST funcCur
          ON cmp.KAI_CODE = funcCur.KAI_CODE
         AND cmp.FNC_CUR_CODE = funcCur.CUR_CODE

WHERE 1 = 1/*IF param.companyCode != null && !"".equals(param.companyCode)*/
    AND swk.KAI_CODE = /*param.companyCode*/
  /*END*//*IF param.slipNo != null && !"".equals(param.slipNo)*/
    AND swk.SWK_DEN_NO = /*param.slipNo*/
  /*END*//*IF param.bookNo != 0*/
    AND swk.SWK_BOOK_NO = /*param.bookNo*/
  /*END*//*IF param.adjDivisionList != null*/
    AND swk.SWK_ADJ_KBN IN /*param.adjDivisionList*/()
  /*END*//*IF param.slipNoList != null */
    AND swk.SWK_DEN_NO IN /*param.slipNoList*/()
  /*END*//*IF param.slipNoLike != null && !"".equals(param.slipNoLike) */
    AND swk.SWK_DEN_NO /*$param.slipNoLike*/
  /*END*//*IF param.slipNoFrom != null && !"".equals(param.slipNoFrom) */
    AND swk.SWK_DEN_NO >= /*param.slipNoFrom*/
  /*END*//*IF param.slipNoTo != null && !"".equals(param.slipNoTo) */
    AND swk.SWK_DEN_NO <= /*param.slipNoTo*/
  /*END*//*IF param.dataKindList != null */
    AND swk.SWK_DATA_KBN IN /*param.dataKindList*/()
  /*END*//*IF param.slipTypeList != null */
    AND swk.DEN_SYU_CODE IN /*param.slipTypeList*/()
  /*END*//*IF param.slipStateList != null */
    AND swk.SWK_UPD_KBN IN /*param.slipStateList*/()
  /*END*//*IF param.slipDateFrom != null */
    AND swk.SWK_DEN_DATE >= /*param.slipDateFrom*/
  /*END*//*IF param.slipDateTo != null */
    AND swk.SWK_DEN_DATE <= /*param.slipDateTo*/
  /*END*//*IF param.autoDivision != -1 */
    AND swk.SWK_AUTO_KBN = /*param.autoDivision*/
  /*END*//*IF  param.order != null && !"".equals(param.order) */
