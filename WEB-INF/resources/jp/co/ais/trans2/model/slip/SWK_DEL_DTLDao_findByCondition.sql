SELECT
  ...
  keyCur.CUR_CODE   KEY_CUR_CODE,         --  基軸通貨
  keyCur.DEC_KETA   KEY_CUR_DEC_KETA,     --  基軸通貨小数点桁数
  funcCur.CUR_CODE  FUNC_CUR_CODE,        --  機能通貨
  funcCur.DEC_KETA  FUNC_CUR_DEC_KETA,    --  機能通貨小数点桁数
  NULL SWK_IRAI_DEP_CODE,
  NULL SWK_IRAI_EMP_CODE
FROM SWK_DEL_DTL swk
